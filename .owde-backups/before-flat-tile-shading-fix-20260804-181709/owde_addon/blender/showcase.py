...
def configure_render(
    *,
    ...
    # Blender has used different Eevee enum names across versions.
    # Blender 5.x exposes BLENDER_EEVEE, while some earlier 4.x builds
    # used BLENDER_EEVEE_NEXT.
    available_engines = {
        item.identifier
    ...
    if "BLENDER_EEVEE" in available_engines:
        ...
        raise RuntimeError(
            "OWDE could not find a supported Blender render engine. "
