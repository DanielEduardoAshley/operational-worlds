...
class OWDE_OT_create_showcase(
    ...
    output_directory: StringProperty(
        ...
        subtype="DIR_PATH",
        default="~/Documents/OperationalWorlds/exports/showcase/",
    )
    ...
    def execute(self, context):
        ...
        raw_output_directory = (
            self.output_directory.strip()
            or "~/Documents/OperationalWorlds/exports/showcase/"
        )

        output_directory = Path(
            bpy.path.abspath(raw_output_directory)
        ).expanduser().resolve()
        ...
        try:
            ...
            self.report(
                {"ERROR"},
                (
                    "Could not create showcase output directory: "
...
class OWDE_PT_showcase(bpy.types.Panel):
    ...
    def draw(
        ...
        info_box.label(
            text="Applies canonical materials."
        )
        info_box.label(
            text="Creates camera and studio lights."
        )
        ...
        operator.render_image = False

        render_operator = layout.operator(
            "owde.create_showcase",
            text="Create and Render Showcase",
            icon="RENDER_STILL",
        )
